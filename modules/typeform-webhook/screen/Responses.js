...
const Responses = ({
  ...
  useEffect(() => {
    setIsLoading(true); // This action dispatches an api to fetch all the questions related to the current form
  ...
  return <View style={styles.p10}>
      {isLoading && <Loader />}
      <SectionList ListEmptyComponent={emptyComponent} sections={responseList} renderItem={({
      item
