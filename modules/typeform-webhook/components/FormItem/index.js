...
const FormItem = props => {
  ...
  const dispatch = useDispatch(); // State for Switch component
  ...
  return <View style={styles.cardContainer}>
      <View style={styles.card}>
        ...
        false: "#767577",
        true: "#81b0ff"
      }} thumbColor={"#000"} ios_backgroundColor="#3e3e3e" onValueChange={event => toggleSwitch(form?.id, event)} value={webhook.enabled} />
      </View>
      <TouchableOpacity onPress={navigateWithLink} style={styles.responseButton}>
        <Text style={styles.resText}>Survey</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={navigateWithIdToken} style={styles.responseButton}>
