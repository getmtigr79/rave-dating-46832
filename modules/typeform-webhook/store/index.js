...
export const getForms = createAsyncThunk("typform/getForms", async payload => {
  try {
...
export const createWebHook = createAsyncThunk("typform/createWebHook", async ({
  token,
  id,
  isEnable
}) => {
...
export const getWebHook = createAsyncThunk("typform/getWebHook", async ({
  token,
  id
}) => {
  try {
...
export const getResponses = createAsyncThunk("typform/getResponses", async payload => {
  try {
